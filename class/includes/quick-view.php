    ...
    <div class="product modal-padding clearfix">
        ...
        <div class="col_half nobottommargin col_last product-desc">
            ...
            <div class="line"></div>
                ...
                <?php } else { ?>
                    <button id="add_to_cart<?=$row->product_id?>" onclick="add_to_cart('<?=$row->product_id?>','Add')" class="add-to-cart button nomargin add_to_cart_in_quick_view">Purchase</button>
                <?php } ?>
