       ...
       <!-- Header
                    ...
                    <div id="header-wrap">
                        ...
                        <div class="container clearfix">
                            ...
                            <nav id="primary-menu">
                                ...
                                <ul>
									<li class="current"><a href="<?= base_url('pages','home')?>"><div>Home</div></a></li>
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				...
				<h1>Manila Spirits © April De Guzman<br> Finals - Ecommerce for Advance Web Programming</h1>
				<span>"Susuka lang tayo 'di susuko."</span>
				<ol class="breadcrumb">
					<li><a href="#">Home</a></li>
				...
				<div class="container clearfix">
					...
					<div class="product <?=$row_products['product_brands_id']?> clearfix">
						<div class="product-image">
							...
							<a href="<?=base_url('pages','guestProducts?id='.$row_products['product_id'])?>"><img style="width:280px;height:250px" src="../assets/uploads/<?=$row_products['product_brand']?>/<?=$row_image['product_images']?>" alt="<?=$row_products['product_name']?>"></a>
							<?php endforeach;?>
							...
							<div class="product-overlay">
								...
								<?php } else { ?>
								<?php } ?>
								<a href="../class/includes/quick-view1.php?product_id=<?=$row_products['product_id']?>" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
							</div>
						</div>
						<div class="product-desc">
							<div class="product-title"><h3><a href="<?=base_url('pages','guestProducts?id='.$row_products['product_id'])?>"><?= $row_products['product_name']?></a></h3></div>
