                    ...
                    <div id="header-wrap">
                        ...
                        <div class="container clearfix">
                            ...
                            <nav id="primary-menu">
                                ...
                                <ul>
                                    <li><a href="<?= base_url('pages','clienthome')?>"><div>Home</div></a></li>
                                    <?php if(!isset($_SESSION['id'])) { ?> 
                                        <li><a href="<?= base_url('pages','login')?>"><div>Logout</div></a></li>
                                    <?php } else { ?>
                                        <li><a href="<?= base_url('pages','login')?>"><div>Logout</div></a></li>
                                    <?php } ?>                                      
                                </ul>
                            ...
                            <div class="single-product">
                                ...
                                <div class="product">
                                                ...
                                                <div class="flexslider">
                                                    <div class="slider-wrap" data-lightbox="gallery">
                                                        <?php foreach($data->get_product_for_slides($product_id) as $row_slides):?>
                                                            <div class="slide" data-thumb="../assets/uploads/<?=$row->product_brand?>/<?=$row_slides['product_images']?>"><img src="../assets/uploads/<?=$row->product_brand?>/<?=$row_slides['product_images']?>" alt="Alak Picture"></div>
                                                        <?php endforeach;?>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col_two_fifth product-desc">
                                        ...
                                        <?php } else { ?>
                                            <button id="add_to_cart<?=$row->product_id?>" onclick="add_to_cart('<?=$row->product_id?>','Add'),goToCheckOut()" class="add-to-cart button nomargin add_to_cart_in_quick_view">Purchase</button>
                                        <?php } ?>
                                        ...
                                        <div class="oc-item">
                                            <div class="product iproduct clearfix">
                                                ...
                                                <?= $row_product_carousel['product_discount'] == 0 ? '' : '<div class="sale-flash">'.$row_product_carousel['product_discount'].'% Off*</div>';?>
                                                    ...
                                                    <?php } else { ?>
                                                        <a style="cursor:pointer" id="add_to_cart<?=$row_product_carousel['product_id']?>" onclick="add_to_cart('<?=$row_product_carousel['product_id']?>','Add',1),goToCheckOut()" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Purchase </span></a>
                                                    <?php } ?>
